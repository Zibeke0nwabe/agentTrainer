...
const departments = [
  ...
  function renderDepartmentCards(containerId) {
    ...
    // Determine which page we're on: index.html or home.html
    const currentPage = window.location.pathname;
  
    // We update routes in Home.html
    if (currentPage.includes('home.html')) {
      departments.forEach(dept => {
        dept.chatLink = "/loading";  // Update Chat App link for home.html
        dept.callLink = "/voice";   // Update Voice Call link for home.html
      });
    }
